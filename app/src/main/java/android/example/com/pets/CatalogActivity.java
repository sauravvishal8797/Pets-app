...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertPet() {
        ...
        values.put(PetContract.PetEntry.PET_NAME_COL, "Toto");
        values.put(PetContract.PetEntry.PET_BREED_COL, "Terrier");
        values.put(PetContract.PetEntry.PET_GENDER_COL, 0);
        values.put(PetEntry.PET_WEIGHT_COLOUMN, 7);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                PetContract.PetEntry.PET_NAME_COL,
                PetContract.PetEntry.PET_BREED_COL };
